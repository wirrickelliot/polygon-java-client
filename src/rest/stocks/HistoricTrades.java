...
public class HistoricTrades {
    ...
    private HistoricTrades(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String ticker, String date) {
            this.endpoint = String.format("/v2/ticks/stocks/trades/%s/%s", ticker, date);
        }
        ...
        public HistoricTrades build() {
            return new HistoricTrades(this);
        }
    }
}
